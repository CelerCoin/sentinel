...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to celerd "gobject list" output
    ...
    def celerd_serialise(self):
        import celerlib
        return celerlib.SHIM_serialise_for_celerd(self.serialise())
